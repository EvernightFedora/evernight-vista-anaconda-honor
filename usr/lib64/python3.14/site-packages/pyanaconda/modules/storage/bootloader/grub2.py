...
class GRUB2(BootLoader):
    ...
    def write_defaults(self):
        ...
        defaults.write("GRUB_CMDLINE_LINUX=\"rhgb quiet mitigations=off skew_tick=1 transparent_hugepage=always snd-intel-dspcfg.dsp_driver=3 snd-hda-intel.model=generic spectre_bhi=off\"\n")
